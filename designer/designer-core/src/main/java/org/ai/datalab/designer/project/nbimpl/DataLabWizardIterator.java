...
public class DataLabWizardIterator implements WizardDescriptor./*Progress*/InstantiatingIterator {
    ...
    public DataLabWizardIterator() {
    }

    public static DataLabWizardIterator createIterator() {
        return new DataLabWizardIterator();
    }

    private WizardDescriptor.Panel[] createPanels() {
        return new WizardDescriptor.Panel[]{
            new DataLabWizardPanel(),};
    }

    private String[] createSteps() {
        return new String[]{
            NbBundle.getMessage(DataLabWizardIterator.class, "LBL_CreateProjectStep")
        };
    }
